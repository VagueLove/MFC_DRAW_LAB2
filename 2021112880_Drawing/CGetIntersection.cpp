...
void CGetIntersection::Set_data1(int d)
{
	data1 = d;
	dt1set = true;
}
void CGetIntersection::Set_data2(int d)
{
	data2 = d;
	dt2set = true;
}
...
void CGetIntersection::CalCC(CSlist list)
{
	Node* c1 = list.GetElement(data1);
	CCircle* C1 = (CCircle*)(c1->data);
	Node* c2 = list.GetElement(data2);
	CCircle* C2 = (CCircle*)(c2->data);
	Circle_Circle(C1, C2);
}
void CGetIntersection::CalCL(CSlist list)
{
	Node* c = list.GetElement(data1);
	CCircle* C = (CCircle*)(c->data);
	Node* l = list.GetElement(data2);
	CLine* L = (CLine*)(l->data);
	Circle_Line(C, L);
}
void CGetIntersection::CalLC(CSlist list)
{
	Node* c = list.GetElement(data2);
	CCircle* C = (CCircle*)(c->data);
	Node* l = list.GetElement(data1);
	CLine* L = (CLine*)(l->data);
	Circle_Line(C, L);
}
void CGetIntersection::CalLL(CSlist list)
{
	Node* l1 = list.GetElement(data1);
	CLine* L1 = (CLine*)(l1->data);
	Node* l2 = list.GetElement(data2);
